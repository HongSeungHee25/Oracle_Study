...
CREATE TABLE tbl_number(
	...
	zcol number(7,2),	-- 전체 자리수 최대 7자리, 소수점 이하 2자리(고정). n > m 인경우
	zcol2 number(2,5)	-- 소수점이하 최대 5자리(0이 3개 고정), 0아닌 유효 숫자 최대 2자리. n < m 인경우
);
...
-- 12300에서 0 2개는 유효한 값, 00123 에서 0 2개는 무효한 숫자
